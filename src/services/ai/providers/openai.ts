...
/**
 * Minimal OpenAI-compatible chat completion provider. Works with any
 * OpenAI-compatible endpoint (OpenAI, OpenRouter, groq, etc.) by setting:
 *   AI_PROVIDER=openai-aicompat
 *   OPENAI_API_KEY=...
